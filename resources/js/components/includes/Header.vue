              ...
              <li class="nav-item dropdown dropdown-large">
                ...
                <div class="dropdown-menu dropdown-menu-end p-0">
                 ...
                 <div class="header-message-list p-2">
                    ...
                    <a v-for="(user, index) in users" :key="index" class="dropdown-item" href="#">
                        <div class="d-flex align-items-center">
                          <img :src="user.image" alt="" class="rounded-circle" width="52" height="52">
                          <div class="ms-3 flex-grow-1">
                            <h6 class="mb-0 dropdown-msg-user">{{ user.name }} <span class="msg-time float-end text-secondary">{{ user.time }}</span></h6>
                            <small class="mb-0 dropdown-msg-text text-secondary d-flex align-items-center">{{ user.text }}</small>
                          </div>
                        </div>
                    </a>
                </div>
    ...
    data() {
        return {
            users: [
                {
                name: 'Amelio Joly',
                image: '/admin/assets/images/avatars/avatar-1.png',
                time: '1 m',
                text: 'The standard chunk of lorem...',
                },
                {
                name: 'Althea Cabardo',
                image: '/admin/assets/images/avatars/avatar-2.png',
                time: '7 m',
                text: 'Many desktop publishing',
                },
                {
                name: 'Katherine Pechon',
                image: '/admin/assets/images/avatars/avatar-3.png',
                time: '2 h',
                text: 'Making this the first true',
                },
...
<style scoped>
  ...
  .dropdown-menu .router-link-exact-active i{
    color: #000 !important;
  }
</style>